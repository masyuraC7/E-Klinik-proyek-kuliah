...
<title>Pasien Dirawat - Dokter Umum </title>

<?php
    $sql = "SELECT * FROM db_pasien_umum where kondisi = 'Dirawat' ORDER BY tanggalinput desc;";
            ...
            <div class="accordion" id="accordionExample">
                <div class="accordion-item">
                    <h2 class="accordion-header">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#A<?= $row['id_umum']; ?>" aria-expanded="false" aria-controls="A<?= $row['id_umum']; ?>">
...
<script>
    ...
    document.querySelector('#dirawat').classList.add('active');
