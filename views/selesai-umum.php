...
<title>Pasien Sembuh - Dokter Umum </title>

<?php
    $sql = "SELECT * FROM db_pasien_umum where kondisi = 'Sembuh' ORDER BY tanggalinput desc;";
...
<script>
    ...
    document.querySelector('#selesai').classList.add('active');
